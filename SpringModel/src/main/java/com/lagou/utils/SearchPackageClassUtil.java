...
public class SearchPackageClassUtil {
    private static SearchPackageClassUtil searchPackageClassUtil;
    private List<String> classPaths = new ArrayList<String>();
    private List<Class> classes = new ArrayList<Class>();
    private SearchPackageClassUtil(){}
    public static SearchPackageClassUtil init(){
        if(searchPackageClassUtil == null){
            searchPackageClassUtil = new SearchPackageClassUtil();
        }
        return searchPackageClassUtil;
    }
