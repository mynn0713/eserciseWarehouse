...
<body>
    <form action="<%=request.getContextPath()+"/resume/addView"%>" method="post"><input type="submit" value="新增"/></form>
    <table>
        <thead>简历列表</thead>
        <tbody>
        <%
        ...
        %>
            ...
            <tr>
                    ...
                    <td><form action="<%=request.getContextPath()+"/resume/resumeModifyView"%>" method="get">
                        <input type="hidden" name="id" value="<%=resume.getId()%>">
                        <input type="submit" value="编辑">
                    </form></td>
                    <td><form action="<%=request.getContextPath()+"/resume/delete"%>" method="get">
                        <input type="hidden" name="id" value="<%=resume.getId()%>">
